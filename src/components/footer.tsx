...
export function Footer() {
  ...
  return (
    <footer className="relative z-10 w-full bg-[#030914] pt-20 pb-10 overflow-hidden">
      ...
      {/* Background Glow */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-[#00D4FF]/10 blur-3xl transform-gpu rounded-full pointer-events-none"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="md:col-span-2 lg:col-span-6 pr-0 md:pr-12 flex flex-col">
            ...
            <div className="flex flex-col gap-4 mb-12">
              <a href="https://t.me/+_JqY7DXwWpAxOGUx" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-muted-foreground hover:text-[#00D4FF] transition-all duration-300">
